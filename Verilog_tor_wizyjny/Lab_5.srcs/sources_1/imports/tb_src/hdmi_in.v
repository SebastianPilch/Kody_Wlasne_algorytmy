...
//-----------------------------------------------
  ...
  reg v_enable=1'b0;
  reg [10:0]hcounter=0;
  reg [10:0]vcounter=1280+1;//480+7
//-----------------------------------------------
  reg [7:0]red;
  reg [7:0]green;
  reg [7:0]blue;
...
begin
  ...
  begin  
    ...
    rgbfile = $fopen("C:/Users/Sebastian/Desktop/testy_python/Maska_HD.ppm","rb");
